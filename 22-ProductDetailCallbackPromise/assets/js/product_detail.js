...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!findProd) {
        prodContainer.textContent = "product not found!";
    } else {
        prodContainer.innerHTML = `
            ...
            <div class="product-info">
                <div class="product-details">
                    ...
                    <p class="product-price" id="product-price">$${findProd.price}</p>
                    <p class="product-desc">${findProd.description}</p>
                </div>
                <div class="product-rating">
                    <span>*${findProd.rating.rate}</span>
                    <span class="prod-count">(${findProd.rating.count} reviews)</span>
                </div>
        ...
        function updatePrice() {
            priceElem.textContent = "$" + (findProd.price * count).toFixed(2);
        }
...
// TASK 2 (PROMISE ILE CONSOLE'A CIXARDIM)
...
function showProduct(product) {
    ...
    let rating = new Promise((resolve, reject) => {
      setTimeout(() => {
        if (product.rating) {
          resolve(product.rating.rate + " (" +product.rating.count +")");
        } else {
          reject("rating tapilmadi");
        }
      }, 1000);
    });
    ...
    rating
    .then(data => console.log("Rating:", data))
    .catch(error => console.log(error));
  }
